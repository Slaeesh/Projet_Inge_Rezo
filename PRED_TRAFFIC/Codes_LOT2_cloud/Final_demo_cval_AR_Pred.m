...
if ~BATCHMODE
    ...
    switch DATASEL
        case 0;
            ...
            y = filter(1,d,u);
        case 1
            [A data]=textread('C:\Riadh\IR_FUJI\Dropbox\RT-CNES-HW-JYT\Data\20180308\instant_flow_500_3000s.txt',['%n %n']); SigStr='flow_500_3000s'; SVMP=1;
            y=data(:)'; dt=100; clear data A
        case 2
            [A data]=textread('C:\Riadh\IR_FUJI\Dropbox\RT-CNES-HW-JYT\Data\20180308\instant_flow_750_3000s.txt',['%n %n']); SigStr='flow_750_3000s'; SVMP=2;
            y=data(:)'; dt=100; clear data A
    end
    y0=y;
