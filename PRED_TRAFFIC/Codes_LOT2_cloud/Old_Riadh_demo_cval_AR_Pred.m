...
if ~BATCHMODE
    ...
    AGGR=6;     % aggregate over windows of size AGGR (0 or 1 = no aggretation)
    ...
    switch DATASEL
        case 0;
            ...
            y = filter(1,d,u);
        case 1
               %[data]=textread('D:\Dropbox\RT-CNES-HW-JYT\Data\return.txt',['%n']); SigStr='flow_500_3000s'; SVMP=1;
            [data]=textread('C:\Riadh\IR_FUJI\Dropbox\RT-CNES-HW-JYT\Data\return.txt',['%n']); SigStr='flow_500_3000s'; SVMP=1;
